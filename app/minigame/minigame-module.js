import { setupScenes, startMiniGameRenderingLoop, scene, orthoScene } from './minigame-scene.js'
...
const GAME_TYPES = ['Bike', 'ChocoboRace', 'SnowboardIcicleVersion', 'FortConder',
    'Submarine', 'SpeedSquare', 'SnowboardGoldSaucerVersion']
let RETURN_DATA
